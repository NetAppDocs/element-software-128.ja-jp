...
summary: ListServices メソッドを使用すると、クラスター上で実行されているノード、ドライブ、現在のソフトウェア、およびその他のサービスのサービス情報を一覧表示できます。 
---
= リストサービス
:allow-uri-read: 
:icons: font
...
[role="lead"]
使用することができます `ListServices`クラスター上で実行されているノード、ドライブ、現在のソフトウェア、およびその他のサービスのサービス情報を一覧表示するメソッド。
